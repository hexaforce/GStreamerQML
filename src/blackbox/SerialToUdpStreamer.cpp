...
SerialToUdpStreamer::SerialToUdpStreamer(const std::string &serialPort, unsigned int baudRate, const std::string &udpIp, unsigned short udpPort)
    : serial_port_name(serialPort), baud_rate(baudRate), udp_ip(udpIp), udp_port(udpPort), serial_port(-1), udp_socket(-1) {}
